...
They run before or after each test function to which the function is applied.
They are used to feed data tot he tests such db connections, urls to test and input data.
